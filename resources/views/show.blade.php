        ...
        <div class="columns">
            <div class="column is-10 is-offset-1">
                ...
                <div class="box has-text-centered">
                  <h1 class="is-size-5 is-size-6-mobile is-uppercase is-family-code">{{ $project->title }} <a class="button is-light is-small is-primary" href="../edit/{{$project->slug}}">Edit</a>
                  </h1>
